    ...
    <el-row gutter="20" class="json-format" style="height: 100%;">
        ...
        <el-col :span="12" style="height: 100%;">
            <el-card class="card" body-style="height:100%">
                <textarea v-model="jsonLeft" placeholder="在这里粘贴从浏览器控制台复制的cookies " class="json-editor"></textarea>
            </el-card>
        </el-col>
...
import { formatCookies } from "@/api/api"; // 引入封装的方法
    ...
    methods: {
        async fetchData(format_str) {
            try {
                ...
                const response = await formatCookies(format_str);
